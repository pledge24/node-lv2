...
var Z = (e, r) => () => (r || e((r = { exports: {} }).exports, r), r.exports),
  Fr = (e, r) => {
    for (var t in r) Ct(e, t, { get: r[t], enumerable: !0 });
  },
  no = (e, r, t, n) => {
...
var k = (e, r, t) => (
    ...
    no(
      r || !e || !e.__esModule
        ? Ct(t, 'default', { value: e, enumerable: !0 })
        : t,
      e
    )
  ),
  Bl = (e) => no(Ct({}, '__esModule', { value: !0 }), e);
var Ao = Z((Bd, Un) => {
  'use strict';
  var v = Un.exports;
...
var Fo = Z((Gd, Lo) => {
  ...
  function Hn(e) {
    ...
    if ('FORCE_HYPERLINK' in r)
      return !(
        r.FORCE_HYPERLINK.length > 0 && parseInt(r.FORCE_HYPERLINK, 10) === 0
      );
    if (
      dr('no-hyperlink') ||
      dr('no-hyperlinks') ||
      ...
      for (var de = b.length - 1; a < o - 3; )
        for (
          ...
          (g = b[l]),
            ...
            (u = g);
      for (; a < o; )
        for (I = t.charCodeAt(s + (u = a)), f = ++a, l = 0; l < de; l += 2)
          (g = b[l]), (b[l] = f = e(g, u, f, I, b[l + 1])), (u = g);
      return f;
    };
  })();
});
...
var po = {
  enabled:
    !ao && lo == null && uo !== 'dumb' && ((On != null && On !== '0') || co),
};
function N(e, r) {
...
globalThis.DEBUG_COLORS ??
  (globalThis.DEBUG_COLORS = Ln.DEBUG_COLORS ? Ln.DEBUG_COLORS === 'true' : !0);
var $r = {
  enable(e) {
...
var ke = Symbol.for('@ts-pattern/matcher'),
  ...
  we = (e, r, t) => {
    ...
    if ($n(e)) {
      ...
      return Object.keys(e).every((n) => {
        let i = e[n];
        return (
          (n in r || (It((o = i)) && o[ke]().matcherType === 'optional')) &&
          we(i, r[n], t)
        );
        var o;
      });
  ...
  je = (e) => {
    ...
    return $n(e)
      ? It(e)
        ? (r =
            (t = (n = e[ke]()).getSelectionKeys) == null
              ? void 0
              : t.call(n)) != null
          ? r
          : []
  ...
  return ce({
    [ke]: () => ({
      match: (r) => {
        ...
        return r === void 0
          ? (je(e).forEach((i) => n(i, void 0)), { matched: !0, selections: t })
...
var Xe = (e) =>
  ...
  be = (e) =>
    Object.assign(ce(e), {
      between: (r, t) =>
        be(j(e, ((n, i) => _((o) => Ee(o) && n <= o && i >= o))(r, t))),
  ...
  qe = (e) =>
    Object.assign(ce(e), {
      between: (r, t) =>
        qe(j(e, ((n, i) => _((o) => $e(o) && n <= o && i >= o))(r, t))),
...
var jn = class e {
  ...
  when(r, t) {
    ...
    return new e(
      this.input,
      n ? { matched: !0, value: t(this.input, this.input) } : qn
    );
  }
  otherwise(r) {
...
var du = { warn: fe('prisma:warn') },
  fu = { warn: () => !process.env.PRISMA_DISABLE_WARNINGS };
function kt(e, ...r) {
...
async function vo() {
  ...
  let t = await Eu(),
    n = await Su(),
    i = wu({ arch: r, archFromUname: n, familyDistro: t.familyDistro }),
    { libssl: o } = await xu(i);
...
function wu(e) {
  return pr(e)
    .with(
      { familyDistro: 'musl' },
      () => (re('Trying platform-specific paths for "alpine"'), ['/lib'])
    )
    .with(
      { familyDistro: 'debian' },
      ({ archFromUname: r }) => (
...
var Dt = {};
async function Co() {
  if (vu(Dt)) return Promise.resolve({ ...Dt, memoized: !0 });
  let e = await vo(),
    r = Tu(e);
  return (Dt = { ...e, binaryTarget: r }), { ...Dt, memoized: !1 };
}
function Tu(e) {
  let {
    platform: r,
...
async function Su() {
  return typeof Ot.default.machine == 'function'
    ? Ot.default.machine()
    : (await Lt('uname -m'))?.trim();
}
function So(e) {
...
function ei(e) {
  let r = e.e,
    ...
    s = pr({ message: r.message, code: r.code })
...
function Br(
  ...
  return (
    Jo(n?.path, r) || (i = Go(r)),
    !n && !i && ti('No Environment variables loaded'),
    i?.dotenvResult.error
      ? console.error(ue(H('Schema Env Error: ')) + i.dotenvResult.error)
      : {
...
function Uu(e, r, t) {
  ...
  if (n && r && i && qt.default.existsSync(r)) {
    let o = ni.default.parse(qt.default.readFileSync(r)),
      s = [];
...
function Go(e) {
  if (Qu(e)) {
    ...
    return {
      dotenvResult: Qo(r),
      message: Ie(
        `Environment variables loaded from ${fr.default.relative(process.cwd(), e)}`
      ),
      path: e,
    };
  ...
  toString() {
    let { config: r } = this,
      t = r.provider.fromEnvVar
        ...
        : r.provider.value,
      n = JSON.parse(
        JSON.stringify({ provider: t, binaryTargets: Hu(r.binaryTargets) })
      );
...
var Oe = class extends V {
  constructor(r, t) {
    super(r, { code: 'P2025', clientVersion: t }),
...
function rc(e) {
  return {
    datamodel: { models: di(e.models), enums: di(e.enums), types: di(e.types) },
  };
}
function di(e) {
...
gi(Zr, 'AnyNull');
var Qt = {
  classes: { DbNull: Yr, JsonNull: zr, AnyNull: Zr },
  instances: { DbNull: new Yr(Ut), JsonNull: new zr(Ut), AnyNull: new Zr(Ut) },
};
function gi(e, r) {
  Object.defineProperty(e, 'name', { value: r, configurable: !0 });
}
...
var hi = class {
  ...
  yi = (e) => {
    ...
    return (
      e.getConnectionInfo &&
        (n.getConnectionInfo = nc(r, e.getConnectionInfo.bind(e))),
      n
    );
  },
  tc = (e, r) => ({
...
var Gt = { enumerable: !0, configurable: !0, writable: !0 };
function Jt(e) {
  let r = new Set(e);
  return {
...
d.cubeRoot = d.cbrt = function () {
  ...
  for (
    ...
    if (
      ...
      K(a.d).slice(0, s) === (t = K(n.d)).slice(0, s))
    )
...
d.decimalPlaces = d.dp = function () {
  var e,
    ...
    t = NaN;
  if (r) {
    if (((e = r.length - 1), (t = (e - ee(this.e / E)) * E), (e = r[e]), e))
      for (; e % 10 == 0; e /= 10) t--;
    t < 0 && (t = 0);
  }
  return t;
...
d.hyperbolicCosine = d.cosh = function () {
  ...
  (t = s.precision),
    ...
    (i = o.d.length),
    i < 32
      ? ((e = Math.ceil(i / 3)), (r = (1 / en(4, e)).toString()))
...
d.inverseTangent = d.atan = function () {
  ...
  for (
    x = !1, r = Math.ceil(a / E), n = 1, l = u.times(u), s = new c(u), i = u;
    e !== -1;
...
d.precision = d.sd = function (e) {
  ...
  return (
    t.d ? ((r = ws(t.d)), e && t.e + 1 > r && (r = t.e + 1)) : (r = NaN), r
  );
};
d.round = function () {
  var e = this,
...
d.squareRoot = d.sqrt = function () {
  ...
  for (
    ...
    if (
      ...
      K(o.d).slice(0, t) === (r = K(n.d)).slice(0, t))
    )
...
d.toDecimalPlaces = d.toDP = function (e, r) {
  ...
  return (
    ...
    e === void 0
      ? t
      : (oe(e, 0, Ge),
        r === void 0 ? (r = n.rounding) : oe(r, 0, 8),
        y(t, e + t.e + 1, r))
  );
};
d.toExponential = function (e, r) {
  ...
  return (
    e === void 0
      ? (t = ve(n, !0))
      : (oe(e, 0, Ge),
        r === void 0 ? (r = i.rounding) : oe(r, 0, 8),
        (n = y(new i(n), e + 1, r)),
        (t = ve(n, !0, e + 1))),
...
d.toFixed = function (e, r) {
  ...
  return (
    e === void 0
      ? (t = ve(i))
      : (oe(e, 0, Ge),
        r === void 0 ? (r = o.rounding) : oe(r, 0, 8),
...
d.toNearest = function (e, r) {
  ...
  return (
    e.d[0]
      ? ((x = !1), (t = F(t, e, 0, r, 1).times(e)), (x = !0), y(t))
      : ((e.s = t.s), (t = e)),
    t
  );
};
...
d.toPower = d.pow = function (e) {
  ...
  if (((r = ee(e.e / E)), r >= e.d.length - 1 && (t = u < 0 ? -u : u) <= lc))
  ...
  return (
    ...
    r > l.maxE + 1 || r < l.minE - 1
      ...
      : ((x = !1),
        ...
        (i = vi(e.times(Ue(a, n + t)), n)),
        i.d &&
          ((i = y(i, n + 5, 1)),
          rt(i.d, n, o) &&
            ((r = n + 10),
            (i = y(vi(e.times(Ue(a, r + t)), r), r + 5, 1)),
...
d.toSignificantDigits = d.toSD = function (e, r) {
  ...
  return (
    e === void 0
      ...
      : (oe(e, 1, Ge), r === void 0 ? (r = n.rounding) : oe(r, 0, 8)),
    y(new n(t), e, r)
  );
};
d.toString = function () {
...
function K(e) {
  ...
  if (i > 0) {
    for (o += s, r = 1; r < i; r++)
      (n = e[r] + ''), (t = E - n.length), t && (o += Be(t)), (o += n);
...
function cc(e, r) {
  ...
  (n = r.d.length),
    n < 32
      ? ((t = Math.ceil(n / 3)), (i = (1 / en(4, t)).toString()))
...
var F = (function () {
  ...
  return function (n, i, o, s, a, l) {
    ...
    if (
      (O[p] > (z[p] || 0) && c--,
      o == null
        ? ((ae = o = Tt.precision), (s = Tt.rounding))
        : a
          ? (ae = o + (n.e - i.e) + 1)
          : (ae = o),
      ae < 0)
      ...
      if (((ae = (ae / f + 2) | 0), (p = 0), Y == 1)) {
        for (m = 0, O = O[0], ae++; (p < ne || m) && ae--; p++)
          (Lr = m * l + (z[p] || 0)), (S[p] = (Lr / O) | 0), (m = Lr % O | 0);
        g = m || p < ne;
      } else {
        for (
          m = (l / (O[0] + 1)) | 0,
            ...
            u < 0
              ? ((de = C[0]),
                ...
                u == -1 &&
                  ((b = C.length),
                  (u = r(O, C, Y, b)),
                  u < 1 && (m++, t(C, Y < b ? cr : O, b, l))),
                (b = C.length))
              : u === 0 && (m++, (C = [0])),
            (S[p++] = m),
            u && C[0] ? (C[b++] = z[U] || 0) : ((C = [z[U]]), (b = 1));
  ...
  e: if (r != null) {
    ...
    if (((o = r - i), o < 0))
      (o += E),
        ...
        (c = p[(m = 0)]),
        (l = (c / Q(10, i - s - 1)) % 10 | 0);
    else if (((m = Math.ceil((o + 1) / E)), (a = p.length), m >= a))
      if (n) {
        for (; a++ <= m; ) p.push(0);
    ...
    if (
      ...
      return (
        (p.length = 0),
        u
          ? ((r -= e.e + 1), (p[0] = Q(10, (E - (r % E)) % E)), (e.e = -r || 0))
          : (p[0] = e.e = 0),
        e
      );
    if (
...
function ve(e, r, t) {
  ...
  return (
    r
      ? (t && (n = t - s) > 0
          ? (o = o.charAt(0) + '.' + o.slice(1) + Be(n))
          : s > 1 && (o = o.charAt(0) + '.' + o.slice(1)),
        (o = o + (e.e < 0 ? 'e' : 'e+') + e.e))
      : i < 0
        ? ((o = '0.' + Be(-i - 1) + o), t && (n = t - s) > 0 && (o += Be(n)))
        : i >= s
          ? ((o += Be(i + 1 - s)),
            t && (n = t - i - 1) > 0 && (o = o + '.' + Be(n)))
          : ((n = i + 1) < s && (o = o.slice(0, n) + '.' + o.slice(n)),
            t && (n = t - s) > 0 && (i + 1 === s && (o += '.'), (o += Be(n)))),
    o
  );
}
function Xt(e, r) {
...
function vi(e, r) {
  ...
  for (
    r == null ? ((x = !1), (l = g)) : (l = r), a = new m(0.03125);
    e.e > -2;
...
function Ue(e, r) {
  ...
  if (h.s < 0 || !I || !I[0] || (!h.e && I[0] == 1 && I.length == 1))
    return new T(I && !I[0] ? -1 / 0 : h.s != 1 ? NaN : I ? 0 : h);
  if (
    (r == null ? ((x = !1), (c = C)) : (c = r),
    (T.precision = c += g),
    (t = K(I)),
    ...
    (o = h.e),
      n > 1 ? ((h = new T('0.' + t)), o++) : (h = new T(n + '.' + t.slice(1)));
  } else
    return (
      (u = zt(T, c + 2, C).times(o + '')),
      (h = Ue(new T(n + '.' + t.slice(1)), c - g).plus(u)),
      (T.precision = C),
      r == null ? y(h, C, S, (x = !0)) : h
    );
  for (
    p = h,
    ...
    if (
      ...
      if (
        ((l = l.times(2)),
        o !== 0 && (l = l.plus(zt(T, c + 2, C).times(o + ''))),
        (l = F(l, new T(f), c, 1)),
        r == null)
      )
        if (rt(l.d, c - g, S, a))
...
function pc(e, r) {
  ...
  return o < 0
    ...
    : ((e.e = Xt(u, c)),
      ...
      (x = !1),
      s && (e = F(e, i, a * 4)),
      l && (e = e.times(Math.abs(l) < 54 ? Q(2, l) : ir.pow(2, l))),
      (x = !0),
      e);
}
function mc(e, r) {
...
function Ci(e, r, t, n) {
  ...
  if (
    (g
      ? (oe(t, 1, Ge), n === void 0 ? (n = f.rounding) : oe(n, 0, 8))
...
function Cc(e) {
  ...
  for (r = 0; r < o.length; r += 3)
    if (((t = o[r]), i && (this[t] = xi[t]), (n = e[t]) !== void 0))
      if (ee(n) === n && n >= o[r + 1] && n <= o[r + 2]) this[t] = n;
...
function Vc(e) {
  var r,
    ...
    a = [];
  if (
    (e === void 0 ? (e = this.precision) : oe(e, 1, Ge),
    (n = Math.ceil(e / E)),
    this.crypto)
  )
...
var tn = (e) => e,
  nn = { bold: tn, red: tn, green: tn, dim: tn, enabled: !1 },
  Ss = { bold: H, red: ue, green: Me, dim: Ie, enabled: !0 },
  Cr = {
    write(e) {
      e.writeLine(',');
    },
  ...
  on = class {
    ...
    write(r) {
      ...
      this.hasError && t.underline().setColor(r.context.colors.red),
        r.write(t).write(Rs).write(this.value);
    }
  };
    ...
    for (let a of i) {
      ...
      if (
        (s.value instanceof e
          ...
          : s.value instanceof Sr && (l = s.value.getField(Number(a))),
        !l)
      )
        return;
      s = l;
...
function Is(e) {
  ...
  return e instanceof Le
    ...
    : Tr(e)
      ? new J(`prisma.${ps(e.modelName)}.$fields.${e.name}`)
      : Array.isArray(e)
        ? Xc(e)
        : typeof e == 'object'
          ? As(e)
...
function or({ error: e, user_facing_error: r }, t, n) {
  return r.error_code
    ...
    : new B(e, { clientVersion: t, batchRequestIdx: r.batch_request_idx });
}
function rp(e, r) {
  let t = e.message;
  return (
...
function Rr(e = {}) {
  ...
  return Object.entries(r).reduce(
    (n, [i, o]) => (
      Ds[i] !== void 0 ? (n.select[i] = { select: o }) : (n[i] = o), n
    ),
    { select: {} }
  );
}
...
var $s = (e) => (Array.isArray(e) ? e : e.split('.')),
  ...
  qs = (e, r, t) =>
    $s(r).reduceRight(
      (n, i, o, s) => Object.assign({}, Ii(e, s.slice(0, o)), { [i]: n }),
      t
    );
function wp(e, r) {
...
var vp = (e) => e,
  ...
  P = {
    ...
    util: {
      ...
      objId: function (e) {
        return (
          e.__id || Object.defineProperty(e, '__id', { value: ++Tp }), e.__id
        );
      },
        ...
        for (let T = 0; T < I.length; ++T) {
          ...
          for (let U = n, ne = i; U < r.length; ne += r[U].length, ++U) {
            ...
            if (
              ...
              u != 1 && P.matchGrammar(e, r, t, U, ne, !0, h),
              o)
            )
              break;
          }
...
function Gp(e) {
  ...
  return gr(e, (n) => ({ ...n, needs: t(n.name, new Set()) }));
}
function sa(e, r, t) {
  return t
    ? gr(t, ({ needs: n, compute: i }, o) => ({
        name: o,
...
var ca = L('prisma:client'),
  pa = { Vercel: 'vercel', 'Netlify CI': 'netlify' };
function ma({ postinstall: e, ciName: r, clientVersion: t }) {
  if (
    (ca('checkPlatformCaching:postinstall', e),
    ca('checkPlatformCaching:ciName', r),
    e === !0 && r && r in pa)
  ) {
...
function fa() {
  return typeof Netlify == 'object'
    ...
    : typeof EdgeRuntime == 'string'
      ? 'edge-light'
      : globalThis.navigator?.userAgent === Hp
        ? 'workerd'
        : globalThis.Deno
          ? 'deno'
          : globalThis.__lagon__
            ? 'lagon'
            : globalThis.process?.release?.name === Wp
              ? 'node'
              : globalThis.Bun
                ? 'bun'
                : globalThis.fastly
...
async function wa(e, r) {
  ...
  if (
    (zp('enginePath', n), n !== void 0 && e === 'binary' && Xn(n), n !== void 0)
  )
  ...
  let o = await er(),
    ...
    p;
  throw (
    (a && l ? (p = ya(c)) : l ? (p = ga(c)) : u ? (p = ha(c)) : (p = Ea(c)),
...
\`\`\``
      : '',
    c = (0,
    Oi.default)(`Hi Prisma Team! My Prisma Client just crashed. This is the report:
## Versions
...
var ka = {
  ...
  '@prisma/engines-version':
    '5.14.0-25.e9771e62de70f79a5e1c604a2d7c8e2a0a874b48',
  ...
  return new Promise((s, a) => {
    let l = t.request(e, n, (u) => {
      ...
      c >= 301 &&
        c <= 399 &&
        p &&
        (p.startsWith('http') === !1 ? s(ji(`${o}${p}`, r)) : s(ji(p, r))),
  ...
  bt = class {
    constructor(r) {
      ...
      Ia(r),
        ...
        (this.inlineSchema = Aa(r.inlineSchema)),
      ...
      this.startPromise !== void 0 && (await this.startPromise),
        (this.startPromise = (async () => {
          ...
          (this.host = r),
            ...
            (this.remoteClientVersion = await Oa(r, this.config)),
            Bi('host', this.host);
        })()),
    ...
    async requestBatch(
      ...
      return a.map((u) =>
        'errors' in u && u.errors.length > 0
          ? or(u.errors[0], this.clientVersion, this.config.activeProvider)
          : { data: u, elapsed: l }
      );
    }
    requestInternal({
      ...
      return this.withRetry({
        ...
        callback: async ({ logHttpCall: o }) => {
          ...
          a.ok || Bi('graphql response status', a.status),
    ...
    async handleError(r) {
      if (r instanceof lr)
        throw (
          ...
          new _r({ clientVersion: this.clientVersion, cause: r }))
        );
      if (r) throw r;
    }
...
function dm(e) {
  ...
  return (
    process.platform !== 'win32' &&
      (i =
        Gi.default.constants.dlopen.RTLD_LAZY |
        Gi.default.constants.dlopen.RTLD_DEEPBIND),
...
var qa = [...Mn, 'native'],
  ...
  wt = class {
    constructor(r, t) {
      ...
      (this.libraryLoader = t ?? Ma),
        r.engineWasm !== void 0 && (this.libraryLoader = t ?? $a),
        (this.config = r),
    ...
    async getCurrentBinaryTarget() {
      {
        ...
        if (!qa.includes(r))
          throw new R(
            `Unknown ${ue('PRISMA_QUERY_ENGINE_LIBRARY')} ${ue(H(r))}. Possible binaryTargets: ${Me(qa.join(', '))} or a path to the query engine library.
...
${a.backtrace}`,
    ...
    buildQueryError(r) {
      if (r.user_facing_error.is_panic)
        return new le(
          Hi(this, r.user_facing_error.message),
          this.config.clientVersion
        );
      let t = this.getExternalAdapterError(r.user_facing_error);
      return t
        ? t.error
        : or(r, this.config.clientVersion, this.config.activeProvider);
    }
...
function Cm(e, r) {
  let t = e.outputType,
    ...
    i = n?.isEmpty() ?? !1;
  n && (n.removeAllFields(), Ya(n, t)),
    r.addErrorMessage((o) =>
      i
        ? `The ${o.red('`select`')} statement for type ${o.bold(t.name)} must not be empty. ${xt(o)}`
...
function Sm(e, r) {
  ...
  if (i) {
    ...
    s?.hasField(n)
      ? ((o = 'select'), s.getField(n)?.markAsError(), Ya(s, e.outputType))
      : a?.hasField(n)
        ? ((o = 'include'), a.getField(n)?.markAsError(), Fm(a, e.outputType))
        : l?.hasField(n) &&
          ((o = 'omit'), l.getField(n)?.markAsError(), Nm(l, e.outputType));
  }
  r.addErrorMessage((s) => {
...
function Rm(e, r) {
  ...
  n && (n.getField(t)?.markAsError(), Mm(n, e.arguments)),
    r.addErrorMessage((i) =>
      Wa(
        i,
        t,
...
function Im(e, r) {
  let t;
  r.addErrorMessage((l) =>
    t?.value instanceof J && t.value.text === 'null'
...
function Fm(e, r) {
  for (let t of r.fields)
    t.isRelation &&
      !e.hasField(t.name) &&
      e.addSuggestion(new me(t.name, 'true'));
}
function Nm(e, r) {
  for (let t of r.fields)
    !e.hasField(t.name) &&
...
function Mm(e, r) {
  for (let t of r)
    e.hasField(t.name) ||
      e.addSuggestion(new me(t.name, t.typeNames.join(' | ')));
}
function za(e, r) {
  if (r.kind === 'object')
    for (let t of r.fields)
...
function Yi({ select: e, include: r, ...t } = {}, n) {
  let i;
  return (
    n.isPreviewFeatureOn('omitApi') && ((i = t.omit), delete t.omit),
    { arguments: el(t, n), selection: Vm(e, r, i, n) }
  );
}
function Vm(e, r, t, n) {
  return e
...
function Bm(e, r, t) {
  ...
  return (
    ...
    r && Um(n, r, e),
    t && e.isPreviewFeatureOn('omitApi') && Qm(n, t, e),
    n
  );
}
function Um(e, r, t) {
  for (let [n, i] of Object.entries(r)) {
    ...
    o &&
      ...
      i === !0
        ? (e[n] = !0)
        : typeof i == 'object' && (e[n] = Yi(i, t.nestSelection(n)));
  }
}
function Qm(e, r, t) {
...
function Gm(e, r) {
  ...
  for (let [o, s] of Object.entries(i)) {
    ...
    (n?.[o] && !a) ||
      (s === !0
        ? (t[o] = !0)
        : typeof s == 'object' && (t[o] = Yi(s, r.nestSelection(o))));
  }
  return t;
}
function Xa(e, r) {
    ...
    (t) => {
      ...
      if (Array.isArray(t)) {
        ...
        switch (r) {
          ...
          case 'mysql': {
            (n = t.sql),
              (i = { values: Pt(t.values), __prismaRawParameters__: !0 });
            break;
          }
          case 'cockroachdb':
          case 'postgresql':
  ...
  class r {
    constructor(n) {
      ...
      (this._extensions = dn.empty()),
        ...
        (this._clientVersion = e.clientVersion ?? wl),
        (this._activeProvider = e.activeProvider),
        (this._tracingHelper = pl(this._previewFeatures));
      let s = {
          rootEnvPath:
            e.relativeEnvPaths.rootEnvPath &&
            vt.default.resolve(e.dirname, e.relativeEnvPaths.rootEnvPath),
          schemaEnvPath:
            e.relativeEnvPaths.schemaEnvPath &&
            vt.default.resolve(e.dirname, e.relativeEnvPaths.schemaEnvPath),
        },
        a = (!i && Br(s, { conflictCheck: 'none' })) || e.injectableEdgeEnv?.();
      try {
        let l = n ?? {},
          u = l.__internal ?? {},
          c = u.debug === !0;
        ...
        Ol.default.existsSync(p) || (p = e.dirname),
        ...
        if (
          ...
          (this._engine = Va(e, this._engineConfig)),
    ...
    _request(n) {
      ...
      return this._tracingHelper.runInChildSpan(s.operation, () =>
        new kl.AsyncResource('prisma-client-request').runInAsyncScope(() =>
          l(o)
        )
      );
    }
