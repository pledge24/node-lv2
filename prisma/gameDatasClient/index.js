...
if (!fs.existsSync(path.join(__dirname, 'schema.prisma'))) {
  const alternativePaths = ['prisma/gameDatasClient', 'gameDatasClient'];
...
path.join(
  process.cwd(),
  'prisma/gameDatasClient/query_engine-windows.dll.node'
);
// file annotations for bundling tools to include these files
path.join(__dirname, 'schema.prisma');
path.join(process.cwd(), 'prisma/gameDatasClient/schema.prisma');
